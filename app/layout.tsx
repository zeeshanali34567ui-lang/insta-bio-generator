...
export const metadata: Metadata = {
  ...
  description:
    "Create stylish Instagram bios instantly with our free Instagram Bio Generator. Explore bio ideas for boys & girls, including attitude, cool, and VIP styles today.",
  keywords: [
